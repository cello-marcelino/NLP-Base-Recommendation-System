...
<template>
  <div class="admin-dosen-page">
    ...
    <div class="page-header">
      ...
      <router-link to="/admin/dosen/create" class="btn-add">
          ...
          <tr v-for="(dosen, idx) in filteredDosen" :key="dosen.id || idx" class="table-row">
            ...
            <td class="col-center">
              <div class="actions-flex">
                ...
                <router-link :to="`/admin/dosen/${dosen.nidn || dosen.id}/edit`" class="act-btn btn-edit" title="Edit Dosen">
                  Edit
                </router-link>
...
.btn-add {
  ...
  box-shadow: 0 2px 4px rgba(13, 148, 136, 0.2); text-decoration: none;
}
...
.act-btn { border: none; padding: 0.35rem 0.65rem; border-radius: 6px; font-size: 0.75rem; font-weight: 600; cursor: pointer; transition: all 0.15s; text-decoration: none; display: inline-block; }
