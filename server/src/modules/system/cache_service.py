...
from server.src.modules.dosen.dosen_repository import CompositeDosenRepository
from server.src.modules.nlp.preprocessor import Preprocessor
from server.src.modules.nlp.bm25_engine import BM25Engine
from server.src.modules.nlp.sbert_engine import SBERTEngine
...
class CacheService:
    ...
    def initialize_cache(self, force_reload: bool = False):
        with self._lock:
            if self.is_ready and not force_reload:
                return
            self._warm_up()
